...
% Test 1
%Q(1,1) = 10; Q(2,2) = 10; Q(3,3) = 1; R(1,1) = 0.1; R(2,2) = 0.1; R(3,3) = 0.1; 

%Test 2
%Q(1,1) = 10; Q(2,2) = 10; Q(3,3) = 10; R(1,1) = 0.1; R(2,2) = 0.1; R(3,3) = 0.1; 

%Test 3
%Q(1,1) = 10; Q(2,2) = 10; Q(3,3) = 1; R(1,1) = 1; R(2,2) = 0.1; R(3,3) = 0.1; 

%Test 3
Q(1,1) = 10; Q(2,2) = 10; Q(3,3) = 1; R(1,1) = 0.05; R(2,2) = 0.05; R(3,3) = 0.05; 
...
while(loop_num < T / Ts)
    ...
    % Define randomly varying input disturbance
    disturbance = rand(10, 3)/20;
    disturbance(:,1) = disturbance(:,1)/10;

    % Appyl disturbance to the control input
    u = u + disturbance;
